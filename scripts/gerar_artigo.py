...
{{
  ...
  "resumo_executivo": "(2 a 3 frases diretas resumindo o que aconteceu e o que significa juridicamente — para IAs generativas capturarem a essência)",
  "introducao": "(2 a 3 parágrafos apresentando a notícia ou tema, em HTML com tags <p>)",
  "contexto_juridico": "(3 a 4 parágrafos explicando o que isso significa do ponto de vista jurídico e regulatório brasileiro, com referências a leis e normas específicas, em HTML com tags <p> e <h2> onde necessário)",
